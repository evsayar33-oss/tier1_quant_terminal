"""
Tier-1 Adaptive Quant Terminal - Harmonized Metals & Balanced Drivers (v13)
"""
...
ASSET_MATRICES = {
    "SPX": {
        ...
        "factors": [
            ...
            {"id": "asset_liquidity",  "name": "SPY Para Girişi & RVOL", "cluster": "E", "base_weight": 1.6, "base_sign": 1},
            {"id": "market_breadth",   "name": "RSP/SPY Piyasa Genişliği", "cluster": "E", "base_weight": 1.8, "base_sign": 1},
            ...
            {"id": "stagflation_shock","name": "Petrol / Ticaret Şoku", "cluster": "D", "base_weight": 1.6, "base_sign": -1},
            {"id": "usd_strength",     "name": "Dolar Likidite Baskısı", "cluster": "A", "base_weight": 1.5, "base_sign": -1}
        ]
    },
    "NQ": {
        "name": "NASDAQ 100",
        ...
        "factors": [
            ...
            {"id": "semi_lead",        "name": "SMH Çip Sektörü Liderliği", "cluster": "E", "base_weight": 2.5, "base_sign": 1},
            {"id": "asset_liquidity",  "name": "QQQ Para Akışı & Kapanış Gücü", "cluster": "E", "base_weight": 1.6, "base_sign": 1},
            {"id": "real_yield",       "name": "10Y TIPS Reel Faiz", "cluster": "B", "base_weight": 2.0, "base_sign": -1},
            ...
            {"id": "usd_strength",     "name": "DXY Dolar Baskısı", "cluster": "A", "base_weight": 1.5, "base_sign": -1}
        ]
    },
    "XAU": {
        "name": "Ons Altın (Gold)",
        ...
        "vol_scale": 1.0,
        "factors": [
            {"id": "asset_direction",  "name": "Altın 4H Anlık Fiyat Hızı", "cluster": "E", "base_weight": 2.2, "base_sign": 1},
            ...
            {"id": "usd_strength",     "name": "USD Gücü & Dolar Baskısı", "cluster": "A", "base_weight": 2.0, "base_sign": -1},
            {"id": "safe_haven",       "name": "Jeopolitik & Güvenli Liman", "cluster": "C", "base_weight": 1.8, "base_sign": 1},
            {"id": "asset_liquidity",  "name": "Altın Vadeli Hacim Akışı", "cluster": "E", "base_weight": 1.4, "base_sign": 1},
    ...
    "XAG": {
        ...
        "vol_scale": 1.3,
        "factors": [
            {"id": "xag_mom",          "name": "Gümüş 4H Anlık Fiyat Hızı", "cluster": "E", "base_weight": 2.2, "base_sign": 1},
            {"id": "gold_sympathy",    "name": "🥇 Altın Güç İvmesi (Gold Beta)", "cluster": "E", "base_weight": 2.8, "base_sign": 1},
            {"id": "gsr_velocity",     "name": "Altın/Gümüş Rasyosu (GSR İvmesi)", "cluster": "E", "base_weight": 2.0, "base_sign": -1}, # 🛡️ Rasyo artarsa Gümüş EKSİ yer!
            {"id": "real_yield",       "name": "10Y Reel Faiz Baskısı", "cluster": "B", "base_weight": 2.0, "base_sign": -1},
            {"id": "usd_strength",     "name": "USD Gücü & Dolar Baskısı", "cluster": "A", "base_weight": 1.8, "base_sign": -1},
            {"id": "asset_liquidity",  "name": "Gümüş Vadeli Hacim Akışı", "cluster": "E", "base_weight": 1.4, "base_sign": 1},
    ...
    "BTC": {
        ...
        "vol_scale": 2.0,
        "factors": [
            {"id": "crypto_taker",     "name": "⚡ OKX/Bybit Taker Alım Baskısı", "cluster": "E", "base_weight": 3.2, "base_sign": 1},
            ...
            {"id": "usd_strength",     "name": "DXY Dolar Likidite Baskısı", "cluster": "A", "base_weight": 1.8, "base_sign": -1},
    ...
    "ETH": {
        ...
        "factors": [
            ...
            {"id": "eth_btc_beta",     "name": "ETH/BTC Liderlik Gücü", "cluster": "E", "base_weight": 2.2, "base_sign": 1},
            {"id": "btc_sympathy",     "name": "BTC Ana Trend Teyidi", "cluster": "E", "base_weight": 2.0, "base_sign": 1},
