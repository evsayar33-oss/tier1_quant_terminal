"""
Tier-1 Adaptive Quant Terminal - Balanced Factor Matrix (v15)
"""
...
# 🛡️ UÇURUMU VE PUAN PATLAMASINI ENGELLEYEN DENGELİ MATRİS
ASSET_MATRICES = {
    "SPX": {
        "name": "S&P 500 Index",
    ...
    "NQ": {
        ...
        "factors": [
            ...
            {"id": "semi_lead",        "name": "SMH Yarı İletken (Çip/AI) Liderliği", "cluster": "E", "base_weight": 1.6, "base_sign": 1},
            ...
            {"id": "real_yield",       "name": "10Y TIPS Reel Faiz (İskonto Baskısı)", "cluster": "B", "base_weight": 1.8, "base_sign": -1},
    ...
    "XAG": {
        ...
        "factors": [
            ...
            {"id": "gsr_velocity",     "name": "Altın/Gümüş Rasyosu (GSR İvmesi)", "cluster": "E", "base_weight": 1.4, "base_sign": -1},
    ...
    "ETH": {
        ...
        "factors": [
            ...
            {"id": "eth_btc_beta",     "name": "ETH/BTC Liderlik ve Güç", "cluster": "E", "base_weight": 2.0, "base_sign": 1},
